...
namespace Flowchart_Editor.Models.Interface
{
    public interface IBlockForMovements
    {
        ...
        public void SetCoordinateForFirstLine(double сoordinateForFirstLineX1, double сoordinateForFirstLineY1, double сoordinateForFirstLineX2, double сoordinateForFirstLineY2, Line[] lines, Block firstBlock, Block secondBlock);
        public void SetCoordinateForSecondLine(double coordinateForSecondLineX1, double coordinateForSecondLineY1, double coordinateForSecondLineX2, double coordinateForSecondLineY2, Line[] lines, Block firstBlock, Block secondBlock);
        public void SetCoordinateForThirdLine(double сoordinateForThirdLineX1, double сoordinateForThirdLineY1, double сoordinateForThirdLineX2, double сoordinateForThirdLineY2, Line[] lines, Block firstBlock, Block secondBlock);
        public void SetCoordinateForFourthLine(double сoordinateForFourthLineX1, double сoordinateForFourthLineY1, double сoordinateForFourthLineX2, double сoordinateForFourthLineY2, Line[] lines, Block firstBlock, Block secondBlock);
    }
}
